      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="grid items-start gap-8 sm:grid-cols-3">
          ...
          <div className="text-right">
            ...
            <p className="mt-2 leading-relaxed">
              <a href="mailto:privacidade@cadbrasil.com.br" className="hover:text-primary hover:underline">
                privacidade@cadbrasil.com.br
              </a>
              <span className="mx-1">·</span>
              <a href="tel:551121220202" className="hover:text-primary hover:underline">
                (11) 2122-0202
              </a>
            </p>
